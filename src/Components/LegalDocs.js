  ...
  return (
    <div className="legal-section-title">
      ...
      <h2 className="legal-siteTitle" style={{background:"transparent"}}>Privacy Policy for Study Hub International</h2>
        ...
        <p className="legal-title">Information we collect</p>
        <p className="legal-description">
        ...
        <p className="legal-title">Log Files
        </p>
        <p className="legal-description">
        Study Hub International follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.
        </p>

        <p className="legal-title">Cookies and Web Beacons
        ...
        <p className="legal-title">Our Advertising Partners
        ...
        <p className="legal-title">Advertising Partners Privacy Policies
...
You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers' respective websites.
        ...
        <p className="legal-title">CCPA Privacy Rights (Do Not Sell My Personal Information)
        ...
        <p className="legal-title">GDPR Data Protection Rights
        ...
        <p className="legal-title">Children's Information
